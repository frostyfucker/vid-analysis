...
export default {
  ...
  Summary: {
    emoji: '📄',
    prompt: `Generate a concise, paragraph-long summary of this video. Place each \
sentence of the summary into an object sent to set_timecodes with the timecode \
of the sentence in the video.`,
  },
