...
// FIX: Import CSSProperties for typing inline styles with custom properties.
    ...
    if (timecodeList) {
      setCurrentCaption(
        timecodeListReversed.find(
          (t: any) => timeToSecs(t.time) <= video.currentTime,
        )?.text,
      );
    }
  };
        ...
        <>
          ...
          <div className="videoControls">
            <div className="videoScrubber">
              <input
                // FIX: Cast style object to CSSProperties to allow for custom properties.
